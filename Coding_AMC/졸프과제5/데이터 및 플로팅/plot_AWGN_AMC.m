%% AWGN Channel에서 Convolution Code 적용시 
...
Throughput=load('Conv_code_awgn_original.mat').Throughput;

% AMC 적용시 throughput data load
Throughput_AMC=load('Conv_code_AWGN_AMC.mat').Throughput;
...
title('Signal Power vs Throughput [Block length=20, AWGN Channel, Code rate=1/2]');
